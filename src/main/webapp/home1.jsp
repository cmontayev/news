    ...
    <%
        ...
        if (news != null) {
            for (int i = 0; i < news.size(); i++) {
                System.out.println(news.get(i).getId());
                System.out.println("-----------------------------");
                        ...
                        <ul class="comments" style="margin: 0px">
                            <li class="clearfix">
                                <img class="rounded-circle"
                                     src="<%=news.get(i).getComments().get(0).getUsers().getPathImage()%>"
                                     width="40">
                                <div class="post-comments" style="background-color: gainsboro; border-radius: 10px">
                                    <p style="margin-left: 30px; margin-bottom: 0px"
                                       class="meta"><%=news.get(i).getComments().get(0).getUsers().getFullName()%> says
                                        :</p>
                                    <p style="margin-left: 30px; margin-bottom: 0px">
                                        <%=news.get(i).getComments().get(0).getComment()%>
                                    </p>
                                </div>
                            </li>
                        </ul>
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                for (let d = 0; d < result.length; d++) {
                    ...
                    htmlCode += "<img class='rounded-circle' src=" + result[d].users.pathImage + " width='40'>";
                    ...
                    htmlCode += "class='meta'>" + result[d].users.fullName + " says :</p>"
                    htmlCode += "<p style = 'margin-left: 30px; margin-bottom: 0px' >" + result[d].comment + " </p></div> </li>"
                }
                htmlCode += "</ul>";
